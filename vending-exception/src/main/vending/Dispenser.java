...
public class Dispenser {
	final private int MINSEL = 1; // �ndice do primeiro item
	final private int MAXSEL = 20; // �ndice do �ltimo item
	final private int VAL = 50; // Pre�o m�ximo dos itens
